...
Take the given filefrom your previous analysis and open it to view the table (e.g. in Excel). For the following analysis, choose how many of the most significant regulators you want to include (e.g. all with a p-value below 0.05).
